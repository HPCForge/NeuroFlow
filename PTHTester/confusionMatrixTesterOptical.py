...
class VGG_NN(nn.Module):                                                        
    def __init__(self, in_channels = 1, num_classes = 5):                       
        ...
        self.fc1 = nn.Linear(32*85*48, num_classes)
...
model = VGG_NN(in_channels=3).to(device)
model.load_state_dict(torch.load("./fixedOpticalCNN.pth",torch.device('cuda')))
...
plt.title('Optical CNN', fontsize="40")
...
plt.savefig('opticalCNNReordered')
print(df_cm)
