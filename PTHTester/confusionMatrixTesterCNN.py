...
dataset = '../Dataset/Processed/Reduced_Event_Dataset/'
...
model.load_state_dict(torch.load("./reducedEventCNN55.pth",torch.device('cuda')))
...
plt.title('Reduced Event CNN', fontsize="40")
...
plt.savefig('reducedEventCNNReordered')
print(df_cm)
